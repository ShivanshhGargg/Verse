...
import { signup, login } from "../services/springApi";
    ...
    try {
      if (mode === "signup") {
        if (step === 1) {
          ...
          if (!email || !password || !firstName || !lastName || !age || !selectedGender) {
      ...
      <div className="relative w-full h-full min-h-screen overflow-hidden bg-[#08080f] flex flex-col">
        ...
        <div className="relative z-10 flex flex-col h-full min-h-screen px-6 pt-12 pb-10">
          ...
          >
            ...
            {/* Error display */}
            {error && (
                <div className="mt-4 text-center text-sm text-red-400" style={{ fontFamily: "var(--font-body)" }}>
                  {error}
                </div>
            )}
            ...
            <div className="flex flex-col gap-3 mt-6">
              <button
                  ...
                  disabled={loading}
                  className="w-full py-4 rounded-2xl text-white font-semibold text-base transition-all active:scale-95 disabled:opacity-50 disabled:active:scale-100"
                  style={{
